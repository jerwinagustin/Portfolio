    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-background-secondary/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border border-primary/20 p-8 sm:p-10 md:p-12 lg:p-16 group hover:border-primary/40 transition-all duration-500"
        >
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground-secondary mb-6 sm:mb-8 px-4">
